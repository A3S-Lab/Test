...
pub use model::{
    ...
    PageContextTheme, PageContextViewport, PageContextVisualViewport, RepairAclProof, RepairActor,
    ...
    RepairFinding, RepairHumanAction, RepairHumanActionKind, RepairIntent, RepairLayoutCanvas,
    RepairLayoutIntent, RepairRelation, RepairSeverity, RepairStatus, RepairStatusEvent,
    RepairTarget, RepairTargetKind, RepairThreadMessage, RepairVerification, StepOutput, Surface,
    ...
    MAX_ASSERTION_STABILITY_MS, MAX_ASSERTION_STABILITY_SAMPLES, MAX_RENDERED_TEXT_ITEMS,
