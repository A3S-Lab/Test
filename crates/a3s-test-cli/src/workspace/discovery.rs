...
pub(super) const TESTKIT_INSTALL_SPEC: &str = "@a3s-lab/testkit@0.6.0";
...
mod tests {
    ...
    fn package_managers_install_the_pinned_registry_version() {
        ...
        assert_eq!(
            ...
            "pnpm add --save-dev @a3s-lab/testkit@0.6.0"
        );
        assert_eq!(
            PackageManager::Yarn.install_command(),
            "yarn add --dev @a3s-lab/testkit@0.6.0"
        );
        assert_eq!(
            PackageManager::Bun.install_command(),
            "bun add --dev @a3s-lab/testkit@0.6.0"
        );
        assert_eq!(
