...
const EN_DESIGN_BOARD_MESSAGES = {
  ...
  capturePage: "Select screenshot area",
  capturePageHelp: "Drag over the visible browser page to capture one area without screen-sharing permission",
  captureRegionTitle: "Drag to select a screenshot area",
  captureRegionHelp: "Release to add the selected area to the board · Esc to cancel",
  captureRegionTooSmall: "Drag a larger area to capture it",
  capturingRegion: "Adding the selected area…",
  cancelCapture: "Cancel screenshot",
  capturingPage: "Selecting area…",
  ...
  imageHelp: "Select an area of the visible page without screen-sharing permission, or add a PNG or JPEG up to 8 MiB.",
  tools: "Design tools",
  ...
  emptyDescription: "Draw with a tool above, select an area of the page, or add a screenshot.",
  ...
  captureFailed: "The selected page area could not be captured. Try another area, or upload, paste, or drop a screenshot.",
...
const ZH_CN_DESIGN_BOARD_MESSAGES: Record<DesignBoardMessageKey, string> = {
  ...
  boardActions: "画板操作",
  capturePage: "框选页面截图",
  capturePageHelp: "在当前可见页面拖动框选截图区域，不需要屏幕录制权限",
  captureRegionTitle: "拖动框选截图区域",
  captureRegionHelp: "松开后直接添加到画板 · 按 Esc 取消",
  captureRegionTooSmall: "请拖动框选一个更大的区域",
  capturingRegion: "正在添加所选区域…",
  cancelCapture: "取消截图",
  capturingPage: "正在框选…",
  ...
  redo: "重做",
  clearBoard: "清空画板",
  imageHelp: "可框选当前页面的可见区域，无需屏幕录制权限；也支持不超过 8 MiB 的 PNG 或 JPEG。",
  tools: "绘图工具",
  styles: "绘图样式",
  toolSelect: "选择",
  toolDraw: "画笔",
  ...
  textInput: "画板文字",
  emptyTitle: "画出你想要的界面",
  emptyDescription: "可以直接绘制、框选页面区域，或添加一张截图。",
  blankBoard: "空白画板",
  ...
  captureFailed: "无法截取所选页面区域，请重新框选，或改用上传、粘贴或拖入截图。",
