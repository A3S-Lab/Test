...
assert.equal(
  ...
  "https://a3s-lab.github.io/Test/guide/testkit.html",
);
assert.deepEqual(packageManifest.bugs, {
  url: "https://github.com/A3S-Lab/Test/issues",
});
...
assertFunctions(
  reactEsm,
  ["A3SReviewOverlay", "A3STestBoundary", "A3STestKit"],
  "ESM React adapter",
);
assertFunctions(
  reactCjs,
...
assert.equal(
  manifests.length,
  1,
  "npm pack returned an unexpected manifest count",
);
