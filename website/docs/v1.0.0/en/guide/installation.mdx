...
| --------------- | ----------------------------------------------- |
| npm             | `npm install --save-dev @a3s-lab/testkit@0.6.2` |
| pnpm            | `pnpm add --save-dev @a3s-lab/testkit@0.6.2`    |
| Yarn            | `yarn add --dev @a3s-lab/testkit@0.6.2`         |
| Bun             | `bun add --dev @a3s-lab/testkit@0.6.2`          |
