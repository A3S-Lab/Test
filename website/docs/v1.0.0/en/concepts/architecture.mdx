...
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| A Web page is dynamic and an observation becomes stale                        | Every public ref is bound to an observation and page revision                                           |
...
| ----------------------------- | -------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| Embedded page context         | `packages/testkit`                                 | Post-render context, component boundaries, source mapping, bounded UI evidence, and optional human review |
...
| `@cN` | Unique Page Context target, actionable only in its observation               |
