---
title: Generate Surface Contracts from PRDs and designs
description: Turn product sources into human-reviewed executable interface contracts without collapsing provenance or authority boundaries.
---

# Generate Surface Contracts from PRDs and designs

PRDs, designs, and browser accessibility trees describe different kinds of facts. A3S Test does not collapse them into an invented tree. It first converts product sources into cited candidates, lets a person review them into an executable Surface Contract, then reconciles that contract with real browser and Test Kit observations.
