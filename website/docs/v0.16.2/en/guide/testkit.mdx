...
description: Publish revisioned page context after browser rendering and add human marking with repair handoff.
---

# Embedded Web Test Kit

`@a3s-lab/testkit` is a development-time page-context and human-review SDK. After browser rendering, it reads semantic DOM, open Shadow DOM, form state, layout, and viewport facts without writing test attributes onto product elements.
