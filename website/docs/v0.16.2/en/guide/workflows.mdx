---
title: Exploration and regression workflows
description: Understand the responsibility boundaries between external-planner sessions, deterministic ACL suites, and embedded planners.
---

# Exploration and regression workflows

A3S Test has two primary workflows. They are two planning entries into one typed execution core, not separate test engines.
