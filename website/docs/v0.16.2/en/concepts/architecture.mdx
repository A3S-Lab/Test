...
description: How A3S Test separates planning, typed execution, surface adapters, evidence, and repair authority.
---

# Architecture and authority boundaries

A3S Test starts from one principle: a test verdict must come from verifiable facts, and advice must never silently become action authority. The architecture is organized around factual sources, action admission, runtime ownership, and reproducible evidence.
