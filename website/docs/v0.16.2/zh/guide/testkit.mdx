---
title: 嵌入式 Web Test Kit
description: 在浏览器渲染后发布版本化页面上下文，并提供人工标记与修复交接。
---

# 嵌入式 Web Test Kit

`@a3s-lab/testkit` 是开发期页面上下文与人工评审 SDK。它在浏览器完成渲染后读取语义 DOM、开放 Shadow DOM、表单状态、布局和视口事实，不会向业务元素写入测试属性。
