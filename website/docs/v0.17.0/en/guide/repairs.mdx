...
| Verify         | `test_repair_verify`                     | Run focused checks on a newer page revision and retain evidence   |
...
6. Record relative changed files and focused checks reported by the coding agent.
